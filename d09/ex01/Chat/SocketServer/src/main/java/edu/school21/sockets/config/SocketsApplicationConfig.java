...
public class SocketsApplicationConfig {
    ...
    @Bean
    MessagesRepository messagesRepository(DataSource dataSource) {
        return new MessagesRepositoryImpl(dataSource);
    }

    @Bean
    Server server(UsersService usersService, MessagesRepository messagesRepository) {
        return new Server(usersService, messagesRepository);
    }
}
